...
ServiceRequest.create!([
  {additional_notes: "I need a power washing estimate.  There are oil stains on my driveway that I need removed.", user_id: 1, users_id: nil, status: "Open", image: ["dirty-driveway.jpg"], order_number: 3265},
  {additional_notes: "Last night's storm damaged my roof.  I need an estimate to repair it.  Trust fund migas pop-up austin slow-carb lomo. Pop-up small batch ugh, iPhone helvetica blog put a bird on it raw denim tacos kickstarter skateboard marfa freegan echo park. ", user_id: 5, users_id: nil, status: "Open", image: ["roof-damage.jpg"], order_number: 67010},
  {additional_notes: "I have an old, dirty bathtub that needs to be resurfaced.  ", user_id: 6, users_id: nil, status: "Open", image: ["dirty-bathtub.jpg"], order_number: 68511},
  {additional_notes: "Due to water damage, a section of drywall is damaged.  I need this fixed ASAP!", user_id: 7, users_id: nil, status: "Quoted", image: ["Water-Damaged-Ceiling-photo.jpg"], order_number: 2579},
