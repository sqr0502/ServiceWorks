...
Quote.create!([
  {amount: "315.0", note: "All our work is backed by a 90 day warranty.", service_request_id: 57, user_id: 7, status: nil},
  {amount: "304.99", note: "We are licensed and bonded. ", service_request_id: 57, user_id: 6, status: nil},
  {amount: "385.0", note: "Your satisfaction is guaranteed.", service_request_id: 57, user_id: 8, status: nil}
])
Review.create!([
  {rating: 4, comment: "test comment", user_id: nil, service_request_id: nil, company_id: nil},
  {rating: 4, comment: "test comment", user_id: nil, service_request_id: nil, company_id: nil},
  {rating: 1, comment: "test comment", user_id: nil, service_request_id: nil, company_id: nil}
])
ServiceRequest.create!([
  {additional_notes: "I need a power washing estimate.  There are oil stains on my driveway that I need removed.", user_id: 5, users_id: nil, status: "Open", image: ["dirty-driveway.jpg"], order_number: 3265},
  {additional_notes: "Last night's storm damaged my roof.  I need an estimate to repair it.  Trust fund migas pop-up austin slow-carb lomo. Pop-up small batch ugh, iPhone helvetica blog put a bird on it raw denim tacos kickstarter skateboard marfa freegan echo park. ", user_id: 10, users_id: nil, status: "Open", image: ["roof-damage.jpg"], order_number: 67010},
  {additional_notes: "I have an old, dirty bathtub that needs to be resurfaced.  ", user_id: 11, users_id: nil, status: "Open", image: ["dirty-bathtub.jpg"], order_number: 68511},
  {additional_notes: "Due to water damage, a section of drywall is damaged.  I need this fixed ASAP!", user_id: 9, users_id: nil, status: "Quoted", image: ["Water-Damaged-Ceiling-photo.jpg"], order_number: 2579}
])
ServiceRequestService.create!([
  {service_request_id: 61, service_id: 34},
  {service_request_id: 57, service_id: 43},
  {service_request_id: 58, service_id: 39},
  {service_request_id: 59, service_id: 45}
])
User.create!([
